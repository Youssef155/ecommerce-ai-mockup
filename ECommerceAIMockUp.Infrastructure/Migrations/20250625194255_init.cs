        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Designs_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingGovernorate = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSuccesed = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AILogs_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AILogs_Designs_DesignId",
                        column: x => x.DesignId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DesignDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DesignDetails_Designs_DesignId",
                        column: x => x.DesignId,
                        principalTable: "Designs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesignDetailsId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_DesignDetails_DesignDetailsId",
                        column: x => x.DesignDetailsId,
                        principalTable: "DesignDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AILogs_AppUserId",
                table: "AILogs",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AILogs_DesignId",
                table: "AILogs",
                column: "DesignId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DesignDetails_DesignId",
                table: "DesignDetails",
                column: "DesignId");

            migrationBuilder.CreateIndex(
                name: "IX_Designs_AppUserId",
                table: "Designs",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_DesignDetailsId",
                table: "OrderItems",
                column: "DesignDetailsId",
                unique: true);
