...
namespace ECommerceAIMockUp.Infrastructure.Migrations
{
    ...
    [Migration("20250704135240_RemoveRequestTypeColumnFromAILogTable")]
    partial class RemoveRequestTypeColumnFromAILogTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ECommerceAIMockUp.Domain.Entities.AILog", b =>
                {
                    ...
                    b.HasOne("ECommerceAIMockUp.Domain.Entities.Design", "Design")
                        .WithOne("AILog")
                        .HasForeignKey("ECommerceAIMockUp.Domain.Entities.AILog", "DesignId")
